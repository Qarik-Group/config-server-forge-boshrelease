...
# The base manifests/config-server-forge.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/config-server-forge.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
